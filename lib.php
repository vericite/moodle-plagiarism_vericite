...
class plagiarism_plugin_vericite extends plagiarism_plugin {
    ...
    public function get_file_results($cmid, $userid, $file, $vericite=null) {
        ...
        $viewPreliminaryReport = plagiarism_vericite_get_setting_boolean($plagiarismsettings , 'vericite_preliminary_report');
    ...
    public function save_form_elements($data) {
        ...
        if ($plagiarismsettings && !empty($data->use_vericite)) {
            ...
            if (strcmp("assign", $data->modulename) == 0) {
                if (plagiarism_vericite_get_setting_boolean($plagiarismsettings, 'vericite_exclude_quotes_default_hideinstructor') == 1) {
                    if(plagiarism_vericite_get_setting_boolean($plagiarismsettings, 'vericite_exclude_quotes_default') == 1) {
                        $data->plagiarism_exclude_quotes = plagiarism_vericite_get_setting_boolean($plagiarismsettings, 'vericite_exclude_quotes_default');
                    } else {
                        unset($data->plagiarism_exclude_quotes);
                    }
                }

                if (plagiarism_vericite_get_setting_boolean($plagiarismsettings, 'vericite_exclude_self_plag_default_hideinstructor') == 1) {
                    if(plagiarism_vericite_get_setting_boolean($plagiarismsettings, 'vericite_exclude_self_plag_default') == 1) {
                        $data->plagiarism_exclude_self_plag = plagiarism_vericite_get_setting_boolean($plagiarismsettings, 'vericite_exclude_self_plag_default');
                    } else {
                        unset($data->plagiarism_exclude_self_plag);
                    }
                }

                if (plagiarism_vericite_get_setting_boolean($plagiarismsettings, 'vericite_store_inst_index_default_hideinstructor') == 1) {
                    if(plagiarism_vericite_get_setting_boolean($plagiarismsettings, 'vericite_store_inst_index_default') == 1) {
                        $data->plagiarism_store_inst_index = plagiarism_vericite_get_setting_boolean($plagiarismsettings, 'vericite_store_inst_index_default');
                    } else {
                ...
                if (plagiarism_vericite_get_setting_boolean($plagiarismsettings, 'vericite_exclude_quotes_default_forums_hideinstructor') == 1) {
                    if(plagiarism_vericite_get_setting_boolean($plagiarismsettings, 'vericite_exclude_quotes_default_forums') == 1) {
                        $data->plagiarism_exclude_quotes = plagiarism_vericite_get_setting_boolean($plagiarismsettings, 'vericite_exclude_quotes_default_forums');
                    } else {
                        unset($data->plagiarism_exclude_quotes);
                    }
                }

                if (plagiarism_vericite_get_setting_boolean($plagiarismsettings, 'vericite_exclude_self_plag_default_forums_hideinstructor') == 1) {
                    if(plagiarism_vericite_get_setting_boolean($plagiarismsettings, 'vericite_exclude_self_plag_default_forums') == 1) {
                        $data->plagiarism_exclude_self_plag = plagiarism_vericite_get_setting_boolean($plagiarismsettings, 'vericite_exclude_self_plag_default_forums');
                    } else {
                        unset($data->plagiarism_exclude_self_plag);
                    }
                }

                if (plagiarism_vericite_get_setting_boolean($plagiarismsettings, 'vericite_store_inst_index_default_forums_hideinstructor') == 1) {
                    if(plagiarism_vericite_get_setting_boolean($plagiarismsettings, 'vericite_store_inst_index_default_forums') == 1) {
                        $data->plagiarism_store_inst_index = plagiarism_vericite_get_setting_boolean($plagiarismsettings, 'vericite_store_inst_index_default_forums');
                    } else {
                        unset($data->plagiarism_store_inst_index);
                    }
                }
    ...
    public function get_form_elements_module($mform, $context, $modulename = '') {
        ...
        // Exclude Quotes
        if(!(
            (strcmp("mod_assign", $modulename) == 0 && plagiarism_vericite_get_setting_boolean($plagiarismsettings, 'vericite_exclude_quotes_default_hideinstructor') == 1) ||
            (strcmp("mod_forum", $modulename) == 0  && plagiarism_vericite_get_setting_boolean($plagiarismsettings, 'vericite_exclude_quotes_default_forums_hideinstructor') == 1)
        )) {
        ...
        // Exclude Self Plag
        if(!(
            (strcmp("mod_assign", $modulename) == 0 && plagiarism_vericite_get_setting_boolean($plagiarismsettings, 'vericite_exclude_self_plag_default_hideinstructor') == 1) ||
            (strcmp("mod_forum", $modulename) == 0  && plagiarism_vericite_get_setting_boolean($plagiarismsettings, 'vericite_exclude_self_plag_default_forums_hideinstructor') == 1)
        )) {
        ...
        // Store in Inst Index
        if(!(
            (strcmp("mod_assign", $modulename) == 0 && plagiarism_vericite_get_setting_boolean($plagiarismsettings, 'vericite_store_inst_index_default_hideinstructor') == 1) ||
            (strcmp("mod_forum", $modulename) == 0  && plagiarism_vericite_get_setting_boolean($plagiarismsettings, 'vericite_store_inst_index_default_forums_hideinstructor') == 1)
        )) {
...
function plagiarism_vericite_get_setting_boolean($plagiarismsettings, $key) {
    return isset($plagiarismsettings[$key]) ? $plagiarismsettings[$key] : false;
}
