...
class DefaultApi
{
    ...
    /**
     * Operation adminConsumerNewConsumerKeyCreatePost
     *
     * 
     *
    ...
    {
        list($response) = $this->adminConsumerNewConsumerKeyCreatePostWithHttpInfo($new_consumer_key, $consumer, $consumer_secret, $consumer_data);
        return $response;
    }

    /**
     * Operation adminConsumerNewConsumerKeyCreatePostWithHttpInfo
     *
     * 
     *
     * @param string $new_consumer_key Key for the new consumer (required)
    ...
    public function adminConsumerNewConsumerKeyCreatePostWithHttpInfo($new_consumer_key, $consumer, $consumer_secret, $consumer_data)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\ConsumerResponse',
                '/admin/consumer/{newConsumerKey}/create'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\ConsumerResponse', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\ConsumerResponse', $e->getResponseHeaders());
    ...
    /**
     * Operation adminConsumerNewConsumerKeyUpdatePut
     *
     * 
     *
    ...
    {
        list($response) = $this->adminConsumerNewConsumerKeyUpdatePutWithHttpInfo($new_consumer_key, $consumer, $consumer_secret, $consumer_data);
        return $response;
    }

    /**
     * Operation adminConsumerNewConsumerKeyUpdatePutWithHttpInfo
     *
     * 
     *
     * @param string $new_consumer_key Key for the consumer to update (required)
    ...
    public function adminConsumerNewConsumerKeyUpdatePutWithHttpInfo($new_consumer_key, $consumer, $consumer_secret, $consumer_data)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $headerParams,
                '\Swagger\Client\Model\ConsumerResponse',
                '/admin/consumer/{newConsumerKey}/update'
            );
    ...
    /**
     * Operation assignmentsContextIDAssignmentIDPost
     *
     * 
     *
    ...
    {
        list($response) = $this->assignmentsContextIDAssignmentIDPostWithHttpInfo($context_id, $assignment_id, $consumer, $consumer_secret, $assignment_data);
        return $response;
    }

    /**
     * Operation assignmentsContextIDAssignmentIDPostWithHttpInfo
     *
     * 
     *
     * @param string $context_id Context ID (required)
    ...
    public function assignmentsContextIDAssignmentIDPostWithHttpInfo($context_id, $assignment_id, $consumer, $consumer_secret, $assignment_data)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\ExternalContentUploadInfo[]',
                '/assignments/{contextID}/{assignmentID}'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\ExternalContentUploadInfo[]', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\ExternalContentUploadInfo[]', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\Error', $e->getResponseHeaders());
    ...
    /**
     * Operation reportsScoresContextIDGet
     *
     * 
     *
     * @param string $context_id Context ID (required)
    ...
    {
        list($response) = $this->reportsScoresContextIDGetWithHttpInfo($context_id, $consumer, $consumer_secret, $assignment_id, $user_id, $external_content_id);
        return $response;
    }

    /**
     * Operation reportsScoresContextIDGetWithHttpInfo
     *
     * 
     *
     * @param string $context_id Context ID (required)
    ...
    public function reportsScoresContextIDGetWithHttpInfo($context_id, $consumer, $consumer_secret, $assignment_id = null, $user_id = null, $external_content_id = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\ReportScoreReponse[]',
                '/reports/scores/{contextID}'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\ReportScoreReponse[]', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\ReportScoreReponse[]', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\Error', $e->getResponseHeaders());
    ...
    /**
     * Operation reportsSubmitRequestContextIDAssignmentIDUserIDPost
     *
     * 
     *
     * @param string $context_id Context ID (required)
    ...
    {
        list($response) = $this->reportsSubmitRequestContextIDAssignmentIDUserIDPostWithHttpInfo($context_id, $assignment_id, $user_id, $consumer, $consumer_secret, $report_meta_data);
        return $response;
    }

    /**
     * Operation reportsSubmitRequestContextIDAssignmentIDUserIDPostWithHttpInfo
     *
     * 
     *
     * @param string $context_id Context ID (required)
    ...
    /**
     * Operation reportsUrlsContextIDGet
     *
     * 
     *
     * @param string $context_id Context ID (required)
    ...
    {
        list($response) = $this->reportsUrlsContextIDGetWithHttpInfo($context_id, $assignment_id_filter, $consumer, $consumer_secret, $token_user, $token_user_role, $user_id_filter, $external_content_id_filter);
        return $response;
    }

    /**
     * Operation reportsUrlsContextIDGetWithHttpInfo
     *
     * 
     *
     * @param string $context_id Context ID (required)
    ...
    public function reportsUrlsContextIDGetWithHttpInfo($context_id, $assignment_id_filter, $consumer, $consumer_secret, $token_user, $token_user_role, $user_id_filter = null, $external_content_id_filter = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\ReportURLLinkReponse[]',
                '/reports/urls/{contextID}'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\ReportURLLinkReponse[]', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\ReportURLLinkReponse[]', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\Error', $e->getResponseHeaders());
